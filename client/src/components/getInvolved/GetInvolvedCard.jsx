    ...
    return (
        ...
        >
            ...
            <Flex direction={{ base: "column", md: "row" }} gap={{ base: 6, md: 10, lg: 14 }} alignItems={{ base: "center", lg: "flex-start" }} zIndex="3">
                <Box position="relative" flexShrink={0} width="100%" maxW="384px" height={{ base: "auto", lg: "384px" }} overflow="visible">
                    {imageDecorations}
                    <Image
                        width="100%"
                        maxW="384px"
                ...
                <VStack alignItems="flex-start" spacing={{ base: 3, md: 4 }} width="100%" ml={{ base: "30px", md: "50px" }}>
                    <Text fontWeight="700" fontStyle="normal" fontSize={{ base: "18px", md: "36px" }} lineHeight="120%">
                        {title}
                    </Text>
                    <Text fontWeight="400" fontStyle="normal" fontSize={{ base: "12px", md: "24px" }} lineHeight="150%"
                        maxW="539px">
                        {description}
                    </Text>
