...
export default function EditMemberCard ({name, position}) {
    return (
        <HStack width="100%" height="62px" border="1px solid rgb(153,153,153)" bgColor="rgb(249,249,249)" p={3} justifyContent="space-between">
            ...
            <Button width="43px" height="25px" border="1px solid rgb(102,102,102)" borderRadius={0} px="10px" py="5px" bgColor="rgb(245,245,245)">
